...
const downloadFileOriginal = async (keypair, filePathToSave, filehash, filesize) => {
    const { address, publicKey } = keypair;
    const sequence = await (0, exports.getCurrentSequenceString)(address);
...
//# sourceMappingURL=remoteFileSystemOriginal.js.map