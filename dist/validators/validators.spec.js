                            ...
                            data: [
                                {
                                    ...
                                    name: 'myName1',
                                    status: Types.ValidatorStatus.Bonded,
                                    votingPower: "".concat(votingPowerOne, "%"),
                                    totalTokens: "".concat(totalTokensOne),
                                    comission: "".concat(parseFloat(comissionOne), "%"),
                                },
                                {
                                    address: 'myAddress2',
                                    name: 'myName2',
                                    status: Types.ValidatorStatus.Bonded,
                                    votingPower: "".concat(votingPowerTwo, "%"),
                                    totalTokens: "".concat(totalTokensTwo),
                                    comission: "".concat(parseFloat(comissionTwo), "%"),
                                },
                            ],
                            page: 1,
                        };
