...
export declare function getRedisClientInstance(): Promise<import("@redis/client").RedisClientType<{
    graph: {
...
export declare const sendDataToRedis: <T>(derivedKeyPair: KeyPairInfo, sampleData: T) => Promise<number | undefined>;
