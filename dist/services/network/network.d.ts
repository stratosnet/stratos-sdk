...
export declare const requestBalanceIncrease: (walletAddress: string, faucetUrl: string, denom?: string, config?: Types.NetworkAxiosConfig | undefined) => Promise<Types.SubmitTransactionDataResult>;
