...
describe('bigNumber (unit test)', function () {
    ...
    describe('toWei', function () {
        ...
        it('returns formatted value in wei using default precission', function () {
            ...
            expect(result.toString()).toStrictEqual('1000000000');
        });
    });
    describe('fromWei', function () {
        ...
        it('returns formatted value in wei using default precission', function () {
            ...
            expect(result.toString()).toStrictEqual('1e-9');
        });
    });
    ...
    describe('minus', function () {
        it('substracts given value from the given big number', function () {
            var numOne = '5.5';
            var numTwo = '2.2';
            var result = MyBigNumber.minus(numOne, numTwo);
            expect(result.toString()).toStrictEqual('3.3');
        });
        it('returns NaN if one of the arguments is not a number', function () {
            var numOne = '1.16';
            var numTwo = 'foo';
