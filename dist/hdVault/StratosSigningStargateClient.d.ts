...
export declare class StratosSigningStargateClient extends SigningStargateClient {
    ...
    getEthSecpStratosEncodedPubkey(signerAddress: string): Promise<Any>;
    getCosmosEncodedPubkey(signerAddress: string): Promise<Any>;
    signDirectStratos(signerAddress: string, messages: readonly EncodeObject[], fee: StdFee, memo: string, { accountNumber, sequence, chainId }: SignerData): Promise<TxRaw>;
}
