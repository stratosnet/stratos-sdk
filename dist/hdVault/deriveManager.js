...
exports.derivePrivateKeySeed = exports.getSlip10 = exports.deriveKeyPairFromPrivateKeySeed = exports.deriveAddressFromPhrase = void 0;
var CosmosCrypto = __importStar(require("@cosmjs/crypto"));
var encoding_1 = require("@cosmjs/encoding");
var keyUtils_1 = require("./keyUtils");
var deriveAddressFromPhrase = function (phrase) { return __awaiter(void 0, void 0, void 0, function () {
    var masterKeySeed, pubkey;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, keyUtils_1.generateMasterKeySeed)(phrase)];
            case 1:
                masterKeySeed = _a.sent();
                return [4 /*yield*/, (0, keyUtils_1.getMasterKeySeedPublicKey)(masterKeySeed)];
            case 2:
                pubkey = _a.sent();
                return [2 /*return*/, (0, keyUtils_1.getAddressFromPubKey)(pubkey)];
        }
    });
}); };
...
var getSlip10 = function () {
    return CosmosCrypto.Slip10;
};
exports.getSlip10 = getSlip10;
var derivePrivateKeySeed = function (masterKey, keyPath, curve) {
    if (curve === void 0) { curve = CosmosCrypto.Slip10Curve.Secp256k1; }
    var convertedPath = CosmosCrypto.stringToPath(keyPath);
    var privkey = (0, exports.getSlip10)().derivePath(curve, masterKey, convertedPath).privkey;
    return privkey;
};
