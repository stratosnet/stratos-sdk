...
const sendUserUploadSign = async (extraParams, config) => {
    const msgId = 1;
...
exports.sendUserUploadSign = sendUserUploadSign;
...
const sendUserRequestDeleteFile = async (extraParams, config) => {
    const msgId = 1;
...
exports.sendUserRequestDeleteFile = sendUserRequestDeleteFile;
