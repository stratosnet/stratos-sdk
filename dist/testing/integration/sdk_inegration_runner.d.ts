...
export declare const downloadFileFromRemoteBySharedLink: (fileReadName: string, randomTestPreffix: string, hdPathIndex?: number, givenReceiverMnemonic?: string) => Promise<boolean>;
